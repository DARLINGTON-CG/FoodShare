...
import 'application/posts/user_post_watcher/user_post_watcher_bloc.dart'
    as _i23;
import 'application/user_data/user_data_cud/user_data_bloc.dart' as _i21;
import 'application/user_data/user_data_read/user_data_read_bloc.dart' as _i22;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i20.SignInFormBloc>(
      () => _i20.SignInFormBloc(get<_i6.IAuthFacade>()));
  gh.factory<_i21.UserDataBloc>(
      () => _i21.UserDataBloc(get<_i14.IUserRepository>()));
  gh.factory<_i22.UserDataReadBloc>(
      () => _i22.UserDataReadBloc(get<_i14.IUserRepository>()));
  gh.factory<_i23.UserPostBloc>(
      () => _i23.UserPostBloc(get<_i10.IPostRepository>()));
