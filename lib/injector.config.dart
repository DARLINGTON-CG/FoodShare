...
import 'application/messaging/create_messages/create_messages_bloc.dart'
    as _i29;
import 'application/messaging/read_messages/read_messages_bloc.dart' as _i23;
import 'application/payments/payment_bloc.dart' as _i18;
...
import 'application/posts/paid_post_watcher/post_paid_watcher_bloc.dart'
    as _i22;
import 'application/posts/post_actor/post_actor_bloc.dart' as _i19;
import 'application/posts/post_form/post_form_bloc.dart' as _i20;
import 'application/posts/user_post_watcher/user_post_watcher_bloc.dart'
    as _i27;
import 'application/user_data/user_data_cud/user_data_bloc.dart' as _i25;
import 'application/user_data/user_data_read/user_data_read_bloc.dart' as _i26;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i19.PostActorBloc>(
      () => _i19.PostActorBloc(get<_i12.IPostRepository>()));
  gh.factory<_i20.PostFormBloc>(
      () => _i20.PostFormBloc(get<_i12.IPostRepository>()));
  gh.factory<_i21.PostFreeWatcherBloc>(
      () => _i21.PostFreeWatcherBloc(get<_i12.IPostRepository>()));
  gh.factory<_i22.PostPaidWatcherBloc>(
      () => _i22.PostPaidWatcherBloc(get<_i12.IPostRepository>()));
  gh.factory<_i23.ReadMessagesBloc>(
      () => _i23.ReadMessagesBloc(get<_i8.IMessageRepository>()));
  gh.factory<_i24.SignInFormBloc>(
      () => _i24.SignInFormBloc(get<_i6.IAuthFacade>()));
  gh.factory<_i25.UserDataBloc>(
      () => _i25.UserDataBloc(get<_i16.IUserRepository>()));
  gh.factory<_i26.UserDataReadBloc>(
      () => _i26.UserDataReadBloc(get<_i16.IUserRepository>()));
  gh.factory<_i27.UserPostBloc>(
      () => _i27.UserPostBloc(get<_i12.IPostRepository>()));
  gh.factory<_i28.AuthBloc>(() => _i28.AuthBloc(get<_i6.IAuthFacade>()));
  gh.factory<_i29.CreateMessagesBloc>(
      () => _i29.CreateMessagesBloc(get<_i8.IMessageRepository>()));
  return get;
}
